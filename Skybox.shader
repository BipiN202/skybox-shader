Shader "Skybox/Dual Panoramic" { //This line declares the shader and gives it a name, "Skybox/Dual Panoramic".
	Properties{ //This block defines the properties of the shader, such as colors, exposures, rotations, textures, and layout options.
		_Tint1("Tint Color 1", Color) = (.5, .5, .5, .5)//These lines define two tint colors for the skybox.
